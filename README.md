# Doku - Webshop lokal starten

## Requirements: 
> GIT muss lokal installiert sein: https://git-scm.com/download/win
...
(Der Link wird nach Ausführung von `python main.py` im Terminal vorgegeben und kann mit strg+'click' geöffnet werden)
